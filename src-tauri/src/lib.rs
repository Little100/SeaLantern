...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            server_commands::remove_server_from_list,
            server_commands::delete_server_files,
            server_commands::get_server_logs,
            server_commands::get_server_commands,
            server_commands::request_server_commands,
            server_commands::send_tab_complete,
            server_commands::get_tab_completions,
